...
from .prayer_views import prayer_settings, get_prayer_times_api, create_prayer, update_prayer, delete_prayer
...
from .analytics_views import analytics_dashboard, get_chart_data_api
